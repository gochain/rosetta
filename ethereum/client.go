...
import (
	...
	EthTypes "github.com/gochain/gochain/v3/core/types"
...
func (ec *Client) getBlock(
	...
	*types.Block,
	...
	if err != nil {
		...
		return nil, nil, gochain.NotFound
	}
...
func (ec *Client) Balance(
	...
	bl, err := ec.Block(ctx, block)
	if err != nil {
		return nil, err
	}
	blockIdentifier := toBlockNumArg(big.NewInt(bl.BlockIdentifier.Index))
	fmt.Println("Got block:", blockIdentifier)
	var result hexutil.Big
	err = ec.c.CallContext(ctx, &result, "eth_getBalance", account.Address, blockIdentifier)
	fmt.Println("Checking the balance for:", account.Address)
	fmt.Println("GOT the balance for:", result)
	if err != nil {
		return nil, err
	}
	...
	return &RosettaTypes.AccountBalanceResponse{
		...
		BlockIdentifier: &RosettaTypes.BlockIdentifier{
			Hash:  bl.BlockIdentifier.Hash,
			Index: bl.BlockIdentifier.Index,
		},
	}, nil
}
